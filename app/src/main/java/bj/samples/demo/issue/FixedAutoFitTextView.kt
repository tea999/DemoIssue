 ...
 */
class FixedAutoFitTextView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyle: Int = android.R.attr.textViewStyle) : AppCompatTextView(context, attrs, defStyle) {
        ...
        sizeTester = object : SizeTester {
            ...
            override fun onTestSize(suggestedSize: Int, availableSpace: RectF): Int {
                ...
                if (transformationMethod != null)
                    text = transformationMethod.getTransformation(getText(), this@FixedAutoFitTextView).toString()
                else
